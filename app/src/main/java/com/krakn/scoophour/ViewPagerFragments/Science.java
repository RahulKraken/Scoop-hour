...
public class Science extends Fragment {
    ...
    class ScienceNetworkTask extends AsyncTask<Integer, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressBar = rootView.findViewById(R.id.scienceProgress_bar);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            RecyclerView recyclerView = rootView.findViewById(R.id.scienceRecyclerView);
