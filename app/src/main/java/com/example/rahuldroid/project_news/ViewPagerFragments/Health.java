...
public class Health extends Fragment {
    ...
    class HealthNetworkTask extends AsyncTask<Integer, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressBar = rootView.findViewById(R.id.healthProgress_bar);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            RecyclerView recyclerView = rootView.findViewById(R.id.healthRecyclerView);
